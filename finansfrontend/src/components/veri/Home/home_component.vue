...
<template>
  ...
  <div class="home_comp flex flex-row content-between outline outline-blue-950">
    <div id="baslik" class="font-bold h-100vh pl-4 my-1 rounded-2xl py-2">
      ...
      <!--      <a href="../../../../../FinansBackend/docs/_build/html/index.html"> Backend Dökümantasyon</a>-->
      ...
      <br>
      <a class="text-xl transition-all"
      >Sayfanın en sağ üstünde yer alan <b> "Nasıl Kullanılır?" </b> butonu ile uygulamayı nasıl kullanacağınızı
        öğrenebilirsiniz.</a
      >
      <br>
      <div class="mt-7">
      ...
      <div class="my-5 btn">
        <a class=" font-bold" href="../../../../docs/index.html"> Frontend JavaScript Dökümantasyon </a>
      </div>

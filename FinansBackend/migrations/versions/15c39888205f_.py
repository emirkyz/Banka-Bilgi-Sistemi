...
Revision ID: 15c39888205f
Revises: a2533fa9fbe9
Create Date: 2023-12-12 18:38:35.063829
...
revision = '15c39888205f'
down_revision = 'a2533fa9fbe9'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('olusturulma_tarihi', sa.DateTime(), nullable=False),
    sa.Column('guncellenme_tarihi', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['kredi_hesap_id'], ['hesap.id'], ),
